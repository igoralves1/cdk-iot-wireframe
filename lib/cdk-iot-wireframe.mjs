  ...
  constructor(scope, id, props) {
    ...
    const IotCertificateHandlerLambda = new lambda.Function(
      ...
      "IotCertificateHandlerLambda",
      {
        ...
        functionName: "IotCertificateHandlerLambda",
        environment: {
          REGION: this.region,
        },
      }
    ...
    const UploadPayloadLambda = new lambda.Function(
      ...
      "UploadPayloadLambda",
      {
        ...
        functionName: "UploadPayloadLambda",
        environment: {
          REGION: this.region,
    ...
    const thingCreationLambda = new lambda.Function(
      ...
      "ThingCreationLambda",
      {
        ...
        functionName: "ThingCreationLambda",
        environment: {
          REGION: this.region,
        },
      }
    ...
    const deviceRegistrationTable = new dynamodb.Table(
      this,
      "DeviceRegistrationTable",
      {
        tableName: "DeviceRegistrationTable",
    ...
    const certificateActivationLambda = new lambda.Function(
      ...
      "CertificateActivationLambda",
      {
        ...
        functionName: "CertificateActivationLambda",
        environment: {
          REGION: this.region,
          BUCKET_NAME: firstConnectionBucket.bucketName,
          THING_CREATION_LAMBDA_NAME: thingCreationLambda.functionName,
          DEVICE_REGISTRATION_TABLE_NAME: deviceRegistrationTable.tableName,
        },
      }
    );

    deviceRegistrationTable.grantWriteData(certificateActivationLambda);
    ...
    const deviceDataHandlerLambda = new lambda.Function(
      ...
      "DeviceDataHandlerLambda",
      {
        ...
        functionName: "DeviceDataHandlerLambda",
        environment: {
    ...
    const activateDeviceLambda = new lambda.Function(
      ...
      "ActivateDeviceHandlerLambda",
      {
        ...
        functionName: "ActivateDeviceHandlerLambda",
        environment: {
          BUCKET_NAME: deviceDataBucket.bucketName,
          REGION: this.region,
    ...
    const createThingLambda = new lambda.Function(this, "CreateThingLambda", {
      ...
      functionName: "CreateThingLambda",
      environment: {
        REGION: this.region,
        ACCOUNT_ID: cdk.Stack.of(this).account,
      },
    ...
    const deleteThingLambda = new lambda.Function(this, "DeleteThingLambda", {
      ...
      functionName: "DeleteThingLambda",
      environment: {
        REGION: this.region,
        ACCOUNT_ID: cdk.Stack.of(this).account,
      },
